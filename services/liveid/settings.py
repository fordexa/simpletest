...
#######################################################################
# Name of the pickle file to use to store the User ID to Name table.
# Be aware that for the purposes of the sample, the default value
# points to a temporary directory that is publically writable by
# default on many installations.  This directory may be cleaned at any
# time by system processes or an administrator.
#######################################################################
USERDB = '/var/tmp/webauth-python-sample-userdb'
...
#######################################################################
CONTROLSTYLE = urllib.quote('font-size: 10pt; font-family: verdana; background: white;')
